-- Tranzit
CoD.PrivateGameLobby.CustomSurvivalsTranzit = {}
CoD.PrivateGameLobby.CustomSurvivalsTranzit[1] = {}
CoD.PrivateGameLobby.CustomSurvivalsTranzit[1].id = "customMap"
CoD.PrivateGameLobby.CustomSurvivalsTranzit[1].name = "CUSTOM SURVIVAL MAPS"
CoD.PrivateGameLobby.CustomSurvivalsTranzit[1].hintText = "Select Survival Map."
CoD.PrivateGameLobby.CustomSurvivalsTranzit[1].labels = {}
CoD.PrivateGameLobby.CustomSurvivalsTranzit[1].labels[1] = "DISABLED"
CoD.PrivateGameLobby.CustomSurvivalsTranzit[1].labels[2] = "POWER"
CoD.PrivateGameLobby.CustomSurvivalsTranzit[1].labels[3] = "DINER"
CoD.PrivateGameLobby.CustomSurvivalsTranzit[1].labels[4] = "TUNNEL"
CoD.PrivateGameLobby.CustomSurvivalsTranzit[1].labels[5] = "HOUSE"
CoD.PrivateGameLobby.CustomSurvivalsTranzit[1].labels[6] = "CORNFIELD"
CoD.PrivateGameLobby.CustomSurvivalsTranzit[1].values = {}
CoD.PrivateGameLobby.CustomSurvivalsTranzit[1].values[1] = "vanilla"
CoD.PrivateGameLobby.CustomSurvivalsTranzit[1].values[2] = "power"
CoD.PrivateGameLobby.CustomSurvivalsTranzit[1].values[3] = "diner"
CoD.PrivateGameLobby.CustomSurvivalsTranzit[1].values[4] = "tunnel"
CoD.PrivateGameLobby.CustomSurvivalsTranzit[1].values[5] = "house"
CoD.PrivateGameLobby.CustomSurvivalsTranzit[1].values[6] = "cornfield"
CoD.PrivateGameLobby.CustomSurvivalsTranzit[1].maps = {}
CoD.PrivateGameLobby.CustomSurvivalsTranzit[1].maps[1] = "zm_transit"
CoD.PrivateGameLobby.CustomSurvivalsTranzit[1].gameTypes = {}
CoD.PrivateGameLobby.CustomSurvivalsTranzit[1].gameTypes[1] = "zclassic"
-- Die Rise
CoD.PrivateGameLobby.CustomSurvivalsHighrise = {}
CoD.PrivateGameLobby.CustomSurvivalsHighrise[1] = {}
CoD.PrivateGameLobby.CustomSurvivalsHighrise[1].id = "customMap"
CoD.PrivateGameLobby.CustomSurvivalsHighrise[1].name = "CUSTOM SURVIVAL MAPS"
CoD.PrivateGameLobby.CustomSurvivalsHighrise[1].hintText = "Select Survival Map."
CoD.PrivateGameLobby.CustomSurvivalsHighrise[1].labels = {}
CoD.PrivateGameLobby.CustomSurvivalsHighrise[1].labels[1] = "DISABLED"
CoD.PrivateGameLobby.CustomSurvivalsHighrise[1].labels[2] = "ROOFTOP"
CoD.PrivateGameLobby.CustomSurvivalsHighrise[1].labels[3] = "RED ROOM"
CoD.PrivateGameLobby.CustomSurvivalsHighrise[1].values = {}
CoD.PrivateGameLobby.CustomSurvivalsHighrise[1].values[1] = "vanilla"
CoD.PrivateGameLobby.CustomSurvivalsHighrise[1].values[2] = "building1top"
CoD.PrivateGameLobby.CustomSurvivalsHighrise[1].values[3] = "redroom"
CoD.PrivateGameLobby.CustomSurvivalsHighrise[1].maps = {}
CoD.PrivateGameLobby.CustomSurvivalsHighrise[1].maps[1] = "zm_highrise"
CoD.PrivateGameLobby.CustomSurvivalsHighrise[1].gameTypes = {}
CoD.PrivateGameLobby.CustomSurvivalsHighrise[1].gameTypes[1] = "zclassic"
-- MOTD
CoD.PrivateGameLobby.CustomSurvivalsPrison = {}
CoD.PrivateGameLobby.CustomSurvivalsPrison[1] = {}
CoD.PrivateGameLobby.CustomSurvivalsPrison[1].id = "customMap"
CoD.PrivateGameLobby.CustomSurvivalsPrison[1].name = "CUSTOM SURVIVAL MAPS"
CoD.PrivateGameLobby.CustomSurvivalsPrison[1].hintText = "Select Survival Map."
CoD.PrivateGameLobby.CustomSurvivalsPrison[1].labels = {}
CoD.PrivateGameLobby.CustomSurvivalsPrison[1].labels[1] = "DISABLED"
CoD.PrivateGameLobby.CustomSurvivalsPrison[1].labels[2] = "SHOWERS"
CoD.PrivateGameLobby.CustomSurvivalsPrison[1].labels[3] = "DOCKS"
CoD.PrivateGameLobby.CustomSurvivalsPrison[1].labels[4] = "ROOFTOP"
CoD.PrivateGameLobby.CustomSurvivalsPrison[1].labels[5] = "CELLBLOCK"
CoD.PrivateGameLobby.CustomSurvivalsPrison[1].values = {}
CoD.PrivateGameLobby.CustomSurvivalsPrison[1].values[1] = "vanilla"
CoD.PrivateGameLobby.CustomSurvivalsPrison[1].values[2] = "showers"
CoD.PrivateGameLobby.CustomSurvivalsPrison[1].values[3] = "docks"
CoD.PrivateGameLobby.CustomSurvivalsPrison[1].values[4] = "rooftop"
CoD.PrivateGameLobby.CustomSurvivalsPrison[1].values[5] = "cellblock"
CoD.PrivateGameLobby.CustomSurvivalsPrison[1].maps = {}
CoD.PrivateGameLobby.CustomSurvivalsPrison[1].maps[1] = "zm_prison"
CoD.PrivateGameLobby.CustomSurvivalsPrison[1].gameTypes = {}
CoD.PrivateGameLobby.CustomSurvivalsPrison[1].gameTypes[1] = "zclassic"
-- Buried
CoD.PrivateGameLobby.CustomSurvivalsBuried = {}
CoD.PrivateGameLobby.CustomSurvivalsBuried[1] = {}
CoD.PrivateGameLobby.CustomSurvivalsBuried[1].id = "customMap"
CoD.PrivateGameLobby.CustomSurvivalsBuried[1].name = "CUSTOM SURVIVAL MAPS"
CoD.PrivateGameLobby.CustomSurvivalsBuried[1].hintText = "Select Survival Map."
CoD.PrivateGameLobby.CustomSurvivalsBuried[1].labels = {}
CoD.PrivateGameLobby.CustomSurvivalsBuried[1].labels[1] = "DISABLED"
CoD.PrivateGameLobby.CustomSurvivalsBuried[1].labels[2] = "MAZE"
CoD.PrivateGameLobby.CustomSurvivalsBuried[1].values = {}
CoD.PrivateGameLobby.CustomSurvivalsBuried[1].values[1] = "vanilla"
CoD.PrivateGameLobby.CustomSurvivalsBuried[1].values[2] = "maze"
CoD.PrivateGameLobby.CustomSurvivalsBuried[1].maps = {}
CoD.PrivateGameLobby.CustomSurvivalsBuried[1].maps[1] = "zm_buried"
CoD.PrivateGameLobby.CustomSurvivalsBuried[1].gameTypes = {}
CoD.PrivateGameLobby.CustomSurvivalsBuried[1].gameTypes[1] = "zclassic"
-- Origins
CoD.PrivateGameLobby.CustomSurvivalsOrigins = {}
CoD.PrivateGameLobby.CustomSurvivalsOrigins[1] = {}
CoD.PrivateGameLobby.CustomSurvivalsOrigins[1].id = "customMap"
CoD.PrivateGameLobby.CustomSurvivalsOrigins[1].name = "CUSTOM SURVIVAL MAPS"
CoD.PrivateGameLobby.CustomSurvivalsOrigins[1].hintText = "Select Survival Map."
CoD.PrivateGameLobby.CustomSurvivalsOrigins[1].labels = {}
CoD.PrivateGameLobby.CustomSurvivalsOrigins[1].labels[1] = "DISABLED"
CoD.PrivateGameLobby.CustomSurvivalsOrigins[1].labels[2] = "CRAZY PLACE"
CoD.PrivateGameLobby.CustomSurvivalsOrigins[1].labels[3] = "EXCAVATION"
CoD.PrivateGameLobby.CustomSurvivalsOrigins[1].labels[4] = "TRENCHES"
CoD.PrivateGameLobby.CustomSurvivalsOrigins[1].values = {}
CoD.PrivateGameLobby.CustomSurvivalsOrigins[1].values[1] = "vanilla"
CoD.PrivateGameLobby.CustomSurvivalsOrigins[1].values[2] = "crazyplace"
CoD.PrivateGameLobby.CustomSurvivalsOrigins[1].values[3] = "excavation"
CoD.PrivateGameLobby.CustomSurvivalsOrigins[1].values[4] = "trenches"
CoD.PrivateGameLobby.CustomSurvivalsOrigins[1].maps = {}
CoD.PrivateGameLobby.CustomSurvivalsOrigins[1].maps[1] = "zm_tomb"
CoD.PrivateGameLobby.CustomSurvivalsOrigins[1].gameTypes = {}
CoD.PrivateGameLobby.CustomSurvivalsOrigins[1].gameTypes[1] = "zclassic"
...
CoD.PrivateGameLobby.GameTypeSettings[4] = {}
CoD.PrivateGameLobby.GameTypeSettings[4].id = "allowdogs"
CoD.PrivateGameLobby.GameTypeSettings[4].name = "ZMUI_DOGS_CAPS"
CoD.PrivateGameLobby.GameTypeSettings[4].hintText = "ZMUI_DOGS_DESC"
CoD.PrivateGameLobby.GameTypeSettings[4].labels = {}
CoD.PrivateGameLobby.GameTypeSettings[4].labels[1] = "MENU_DISABLED_CAPS"
CoD.PrivateGameLobby.GameTypeSettings[4].labels[2] = "MENU_ENABLED_CAPS"
CoD.PrivateGameLobby.GameTypeSettings[4].values = {}
...
CoD.PrivateGameLobby.GameTypeSettings[4].values[2] = 1
CoD.PrivateGameLobby.GameTypeSettings[4].gameTypes = {}
CoD.PrivateGameLobby.GameTypeSettings[4].gameTypes[1] = "zstandard"
CoD.PrivateGameLobby.GameTypeSettings[4].maps = {}
CoD.PrivateGameLobby.GameTypeSettings[4].maps[1] = "zm_transit"
CoD.PrivateGameLobby.GameTypeSettings[4] = {}
CoD.PrivateGameLobby.GameTypeSettings[4].id = "cleansedLoadout"
CoD.PrivateGameLobby.GameTypeSettings[4].name = "ZMUI_CLEANSED_LOADOUT_CAPS"
CoD.PrivateGameLobby.GameTypeSettings[4].hintText = "ZMUI_CLEANSED_LOADOUT_DESC"
CoD.PrivateGameLobby.GameTypeSettings[4].labels = {}
CoD.PrivateGameLobby.GameTypeSettings[4].labels[1] = "ZMUI_CLEANSED_LOADOUT_SHOTGUN_CAPS"
CoD.PrivateGameLobby.GameTypeSettings[4].labels[2] = "ZMUI_CLEANSED_LOADOUT_GUN_GAME_CAPS"
CoD.PrivateGameLobby.GameTypeSettings[4].values = {}
CoD.PrivateGameLobby.GameTypeSettings[4].values[1] = 0
CoD.PrivateGameLobby.GameTypeSettings[4].values[2] = 1
CoD.PrivateGameLobby.GameTypeSettings[4].gameTypes = {}
...
CoD.PrivateGameLobby.DvarDefaults["customMap"] = "vanilla"
CoD.PrivateGameLobby.Dvars = {}
CoD.PrivateGameLobby.Dvars[1] = {}
...
CoD.PrivateGameLobby.PopulateButtons_Project_Zombie = function (PrivateGameLobbyButtonPane, IsHost)
	if IsHost == true then
		...
		-- 	PrivateGameLobbyButtonPane.body.widestButtonTextWidth = f9_local1_3
		-- end
		AddGameOptionsButtons(PrivateGameLobbyButtonPane, CoD.PrivateGameLobby.CustomSurvivalsTranzit, "dvar")
		AddGameOptionsButtons(PrivateGameLobbyButtonPane, CoD.PrivateGameLobby.CustomSurvivalsHighrise, "dvar")
		AddGameOptionsButtons(PrivateGameLobbyButtonPane, CoD.PrivateGameLobby.CustomSurvivalsPrison, "dvar")
		AddGameOptionsButtons(PrivateGameLobbyButtonPane, CoD.PrivateGameLobby.CustomSurvivalsBuried, "dvar")
		AddGameOptionsButtons(PrivateGameLobbyButtonPane, CoD.PrivateGameLobby.CustomSurvivalsOrigins, "dvar")
